...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('pembayaran')->group(function () {
        ...
        Route::get('/export',    [PemasukanController::class, 'export'])->name('pembayaran.export');
        Route::post('/import',   [PemasukanController::class, 'import'])->name('pembayaran.import');
    ...
    Route::prefix('pelanggan')->group(function () {
        ...
        Route::post('/generate-terpilih', [PelangganController::class, 'generateTagihanTerpilih'])->name('pelanggan.generateTagihanTerpilih');
