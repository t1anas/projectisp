                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-group">
                                    ...
                                    {{-- Tombol Edit --}}
                                    <button class="action-modern btn-edit"
                                            title="Edit"
                                    ...
                                    <form method="POST"
                                          ...
                                          style="margin:0;"
                                          onsubmit="return confirm('Yakin mau hapus tagihan ini?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
...
<div class="modal fade" id="editTagihan{{ $t->id }}" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:18px; border:none; overflow:hidden; box-shadow:0 20px 60px rgba(0,0,0,0.15);">
            ...
            <form action="{{ url('/tagihan/'.$t->id) }}" method="POST">
                ...
                <div class="modal-header bg-warning">
                    <h5 class="modal-title fw-bold">
                        <i class="bi bi-pencil-fill me-1"></i> Edit Tagihan
                    </h5>
